...
- [Android XML views](../../android-xml-views/SKILL.md) — Epoxy attributes are diffed on `hashCode`, so a model attribute's `equals`/`hashCode` decides whether a row rebinds
