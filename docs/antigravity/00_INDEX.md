...
Collection of reference documentation and official guides for Google Antigravity.

## Table of Contents

- [01. Introducing Custom Agents](01_introducing-custom-agents.md) — Architecture, execution symmetry (main vs. subagent), scoped safety policies (`commandExecutionPolicy`), and curated toolsets/skills.
